...
$BLAST -db $refgenesindex -query $CWD/kmers/fasta/allkmers.fasta -out $CWD/refgenes/allkmers_vs_refgenes -perc_identity 100 -word_size 25 -outfmt 6 -num_threads $CORES
awk -v OFS="\t" '$1=$1' $CWD/refgenes/allkmers_vs_refgenes > tmpfile; mv tmpfile $CWD/refgenes/allkmers_vs_refgenes.txt
awk 'BEGIN {print "bin_id\tqueryid\tchromosome\tidentity\talignmentlength\tmismatches\tgapopens\tq.start\tq.end\ts.start\ts.end\tevalue\tbitscore"} {print}' $CWD/refgenes/allkmers_vs_refgenes.txt > tmpfile; mv tmpfile $CWD/refgenes/allkmers_vs_refgenes.blast
rm -f $CWD/refgenes/allkmers_vs_refgenes.txt
rm -f $CWD/refgenes/allkmers_vs_refgenes

printf "======= done optional step 16 =======\n"
