...
awk -v OFS="\t" '$1=$1' $CWD/kmers/Refgenome_blast/candidateXkmers_vs_genome.txt > $TMPDIR/tmpfile; mv $TMPDIR/tmpfile $CWD/kmers/Refgenome_blast/candidateXkmers_vs_genome.txt
...
awk -v OFS="\t" '$1=$1' $CWD/kmers/Refgenome_blast/Xbin_vs_genome.txt > $TMPDIR/tmpfile; mv $TMPDIR/tmpfile $CWD/kmers/Refgenome_blast/Xbin_vs_genome.txt
...
awk -v OFS="\t" '$1=$1' $CWD/kmers/Refgenome_blast/Abin_vs_genome.txt > $TMPDIR/tmpfile; mv $TMPDIR/tmpfile $CWD/kmers/Refgenome_blast/Abin_vs_genome.txt
...
awk -v OFS="\t" '$1=$1' $CWD/kmers/Refgenome_blast/Ybin_vs_genome.txt > $TMPDIR/tmpfile; mv $TMPDIR/tmpfile $CWD/kmers/Refgenome_blast/Ybin_vs_genome.txt
...
awk -v OFS="\t" '$1=$1' $CWD/kmers/Refgenome_blast/GAbin_vs_genome.txt > $TMPDIR/tmpfile; mv $TMPDIR/tmpfile $CWD/kmers/Refgenome_blast/GAbin_vs_genome.txt
fi

printf "======= combining data =======\n"

cat $CWD/kmers/Refgenome_blast/*.txt > $CWD/kmers/Refgenome_blast/blast_vs_genome.blast
awk 'BEGIN {print "bin_id\tqueryid\tchromosome\tidentity\talignmentlength\tmismatches\tgapopens\tq.start\tq.end\ts.start\ts.end\tevalue\tbitscore"} {print}' $CWD/kmers/Refgenome_blast/blast_vs_genome.blast > $TMPDIR/tmpfile; mv $TMPDIR/tmpfile $CWD/kmers/Refgenome_blast/blast_vs_genome.blast
...
awk 'BEGIN {print "chromosome\tstart\tend"} {print}' $CWD/kmers/Refgenome_blast/genome.coordinates > $TMPDIR/tmpfile; mv $TMPDIR/tmpfile $CWD/kmers/Refgenome_blast/genome.coordinates
awk -v OFS="\t" '$1=$1' $CWD/kmers/Refgenome_blast/genome.coordinates > $TMPDIR/tmpfile; mv $TMPDIR/tmpfile $CWD/kmers/Refgenome_blast/genome.coordinates
